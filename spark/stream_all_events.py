...
GCP_GCS_BUCKET = os.getenv("GCP_GCS_BUCKET", 'rhythmflow') # Changed from 'streamify' to 'rhythmflow'
GCS_STORAGE_PATH = f'gs://{GCP_GCS_BUCKET}'

# initialize a spark session
spark = create_or_get_spark_session('RhythmFlow Events Stream') # Changed app name
